...
def mettre_a_jour_connaissances_perso(nouveaux_resultats, fichier=f"projets/veille_metier/veilles/connaissances_perso.csv"):
...
def generate_veille_github():
    ...
    filename = f"projets/veille_metier/veilles/veille_github_{date_str}.csv"
...
def charger_connaissances_data(fichier=f'projets/veille_metier/veilles/connaissances_data.csv'):
    try:
...
def mettre_a_jour_connaissances_data(nouveaux_resultats, fichier=f"projets/veille_metier/veilles/connaissances_data.csv"):
    colonnes = [
...
def automatique_veille_data():
    date_str = datetime.date.today().strftime("%Y-%m")
    filename = f"projets/veille_metier/veilles/veille_data_{date_str}.csv"
    all_results = []
    topics = {
        "python": "Python",
        "r": "R",
